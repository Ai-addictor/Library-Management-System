<%@ Page Title="" Language="C#" MasterPageFile="~/LMS.Master" AutoEventWireup="true" CodeBehind="AdminBookInventory.aspx.cs" Inherits="ElibraryManagement.AdminBookInventory" %>
                                                ...
                                                <div class="col-lg-10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            Description-
                                                            <asp:Label ID="Label12" runat="server" Font-Italic="True" Text='<%# Eval("book_description") %>'></asp:Label>
